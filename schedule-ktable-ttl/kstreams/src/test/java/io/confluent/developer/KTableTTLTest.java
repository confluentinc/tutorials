...
import static io.confluent.developer.KTableTTL.INPUT_TOPIC_STREAM;
import static io.confluent.developer.KTableTTL.INPUT_TOPIC_TABLE;
import static io.confluent.developer.KTableTTL.OUTPUT_TOPIC;
import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.is;

public class KTableTTLTest {

  private final KTableTTL kTableTTL = new KTableTTL();

  @Test
  public void testKTableTTL() {
    Properties properties = new Properties();

    try (TopologyTestDriver testDriver = new TopologyTestDriver(kTableTTL.buildTopology(properties))) {
