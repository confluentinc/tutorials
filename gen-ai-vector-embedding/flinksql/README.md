...
This tutorial is a building block for real-time GenAI applications including [RAG](https://www.confluent.io/learn/retrieval-augmented-generation-rag/). Once vector encoding is complete, you can leverage vector embeddings and vector search to build use cases including:
