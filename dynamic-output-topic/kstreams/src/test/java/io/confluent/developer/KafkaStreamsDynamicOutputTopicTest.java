...
class KafkaStreamsDynamicOutputTopicTest {
    ...
    void shouldChooseTopic() {
        ...
        try (TopologyTestDriver driver = new TopologyTestDriver(topology)) {
            ...
            TestInputTopic<String, Order> inputTopic = driver.createInputTopic(KafkaStreamsDynamicOutputTopic.INPUT_TOPIC, stringSerde.serializer(), orderSerde.serializer());
            TestOutputTopic<String, CompletedOrder> regularOutputTopic = driver.createOutputTopic(KafkaStreamsDynamicOutputTopic.OUTPUT_TOPIC, stringSerde.deserializer(), completedOrderSerde.deserializer());
            TestOutputTopic<String, CompletedOrder> specialOutputTopic = driver.createOutputTopic(KafkaStreamsDynamicOutputTopic.SPECIAL_ORDER_OUTPUT_TOPIC, stringSerde.deserializer(), completedOrderSerde.deserializer());
            ...
            final List<CompletedOrder> expectedRegularCompletedOrders = List.of(
                    new CompletedOrder( "6-COF0003456","coffee",  1_000L * KafkaStreamsDynamicOutputTopic.FAKE_PRICE),
                    new CompletedOrder( "8-BER88899222","beer",  4_000L * KafkaStreamsDynamicOutputTopic.FAKE_PRICE)
            );

            final List<CompletedOrder> expectedSpecialOrders = List.of(
                    new CompletedOrder("5-QUA00000123","tp",  10_000L * KafkaStreamsDynamicOutputTopic.FAKE_PRICE),
                    new CompletedOrder("7-QUA000022334","hand-sanitizer",  6_000L * KafkaStreamsDynamicOutputTopic.FAKE_PRICE)
            );
