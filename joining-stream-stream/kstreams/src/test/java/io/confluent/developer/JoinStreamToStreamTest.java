...
class JoinStreamToStreamTest {
    ...
    void testJoin() {
        JoinStreamToStream jst = new JoinStreamToStream();
        Properties allProps = new Properties();

        String tableTopic = JoinStreamToStream.MOVIE_INPUT_TOPIC;
        String streamTopic = JoinStreamToStream.RATING_INPUT_TOPIC;
        String outputTopic = JoinStreamToStream.RATED_MOVIES_OUTPUT;
