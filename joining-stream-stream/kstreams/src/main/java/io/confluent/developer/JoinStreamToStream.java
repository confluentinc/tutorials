...
public class JoinStreamToStream {
     private static final Logger LOG = LoggerFactory.getLogger(JoinStreamToStream.class);
    ...
    public static void main(String[] args) {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "join-stream-to-stream");
        JoinStreamToStream joinStreamToStream = new JoinStreamToStream();

        Topology topology = joinStreamToStream.buildTopology(properties);
